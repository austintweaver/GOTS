        ...
        <div className="text-center z-10 max-w-4xl mx-auto px-4">
          <div className="animate-fade-in">
            <h1 className="text-6xl md:text-8xl lg:text-9xl font-heading font-bold mb-6">
              <span className="text-brand-red block">Win</span>
              <span className="text-white block">Where It Matters Most</span>
            </h1>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center animate-fade-in">
            ...
            <p className="text-lg text-gray-600 leading-relaxed max-w-3xl mx-auto">
              At Scoreboard Strategy, we understand that success in sports extends far beyond 
              the playing field. Our comprehensive approach combines legal expertise, 
              strategic business guidance, and dedicated representation to help athletes, 
              coaches, and organizations achieve their goals where it matters most—in 
              negotiations, contracts, and long-term career planning.
            </p>
          </div>
        </div>
      </section>
